...
pin fuel cells. Symmetry is exploited by considering a one-twelfth of the
...
# Apply the 'TWELFTH' symmetry type
...
export_layout_to_tdt(
    assembly,
    os.path.join(os.path.dirname(sys.argv[0]), 'test_hex_assembly_twelfth'),
    TdtSetup(
        type_geo=LayoutGeometryType.S30,
