"""
Modelling a hexagonal assembly made of a central pin fuel cell surrounded by
6 rings of pin fuel cells. The hexagon is complete.
"""
import os
import sys
...
export_layout_to_tdt(
    assembly,
    os.path.join(os.path.dirname(sys.argv[0]), 'test_hex_assembly'),
