...
Automated unittests and functional tests are provided in the ``tests/unittest``
and ``tests/functional`` folders respectively.
...
all the test cases in the ``tests/unittest`` folder.
...
.. code-block:: bash
   ...
   salome tests/unittest/run_tests.py
...
.. code-block:: bash
   ...
   salome shell tests/unittest/run_tests.py
...
The ``run_tests.py`` Python script provides the command to automatically run
all the functional test cases in the ``tests/functional`` folder.
